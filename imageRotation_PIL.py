...
class Application(Tkinter.Frame):
    ...
    def createWidgets(self):
        ...
        #default is side = Top
        self.QUIT.grid(row=27, sticky = 'E', pady=10)
    ...
    def convert1(self):
        self.convert_check()
        self.rotateFiles(self.inputlocation, self.outputlocation)
            ...
            for file in os.listdir(src):
                if file.endswith(".JPG") | file.endswith(".jpg"):
                    if file in self.dic:
                        ...
                        img_with_border = ImageOps.expand(img, border=608, fill='black')

                        img_rotate = img_with_border.rotate(-rotation)
                        
                        img_final= img_rotate.crop((608,0, 3648+608,3648))
                        img_final.save(outputImage, subsampling = '4:2:2')
